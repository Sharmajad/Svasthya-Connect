  ...
  return (
    <div className="relative min-h-[700px] lg:min-h-[800px] bg-[#0d9488] pt-20 pb-32">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        {/* Floating Icons */}
        <div className="absolute top-[15%] left-[10%] opacity-20 float-1">
          <Heart size={48} className="text-white" />
        </div>
        <div className="absolute top-[40%] right-[15%] opacity-15 float-2">
          <Stethoscope size={56} className="text-white" />
        </div>
        <div className="absolute bottom-[20%] left-[20%] opacity-10 float-3">
          <Pill size={40} className="text-white" />
        </div>
        <div className="absolute top-[60%] left-[5%] opacity-10 float-4">
          <Activity size={32} className="text-white" />
        </div>
        <div className="absolute bottom-[30%] right-[10%] opacity-20 float-5">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
        ...
        <div className="max-w-4xl mx-auto mb-10 animate-slide-up opacity-0 [animation-fill-mode:forwards] delay-500">
          <div className="bg-white rounded-[24px] p-2 md:p-3 shadow-2xl shadow-black/10">
            <div className="flex flex-col md:flex-row gap-2">
              <div className="md:w-[30%] relative">
                ...
                <select 
                  ...
                  className="w-full bg-gray-50/50 border-none px-10 py-4 rounded-xl font-bold text-gray-700 focus:ring-0 appearance-none cursor-pointer"
                >
              ...
              <div className="flex-1 relative">
                <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-teal-600" size={18} />
                <input
                  type="text"
                  placeholder="Search doctors, speciality..."
                  value={search}
                  onChange={(e) => setSearch(e.target.value)}
                  className="w-full bg-gray-50/50 border-none px-10 py-4 rounded-xl font-medium text-gray-700 focus:ring-0"
                />
              </div>

              <button 
                onClick={() => navigate("/appointment")}
                className="bg-[#0d9488] text-white px-10 py-4 rounded-xl font-bold text-lg hover:bg-[#0b7a6f] transition-all flex items-center justify-center gap-2"
              >
                Search
              </button>
            </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 animate-fade-in opacity-0 [animation-fill-mode:forwards] delay-700">
          {["Cardiologist", "Gynecologist", "Pediatrician", "Dermatologist", "Neurologist", "Orthopedist"].map((cat) => (
            <button 
              key={cat}
              className="bg-white/10 hover:bg-white/20 backdrop-blur-md border border-white/20 text-white px-5 py-2 rounded-full text-xs font-bold transition-all"
            >
              {cat}
            </button>
          ))}
